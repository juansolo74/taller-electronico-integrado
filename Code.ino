...
char msg[] = " * $$$ 0 1 2 3 4 5 hola mundo * "; //Change the text here.


//Columns +
int dataPin1 = 15;  //Arduino pin connected to Data Pin 14 of 74HC595 ,26 atmega(AHORA 24),arduino a1
int latchPin1 = 16; //Arduino pin connected to Latch Pin 12 of 74HC595,27 atmega      (25)         a2
int clockPin1 = 17; //Arduino pin connected to Clock Pin 11 of 74HC595,28 atmega      (26)         a3
 


//Rows -

int dataPin2 = 9;  //Arduino pin connected to Data Pin 14 of 74HC595,17 atmega        (15)
int latchPin2 = 10; //Arduino pin connected to Latch Pin 12 of 74HC595,18 atmega      (16)
int clockPin2 = 11; //Arduino pin connected to Clock Pin 11 of 74HC595,19 atmega      (17)
